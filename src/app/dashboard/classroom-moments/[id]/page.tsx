      ...
      <div className="container mx-auto py-8">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center mb-6">
            <Link href="/dashboard/classroom-moments" className="flex items-center text-muted-foreground hover:text-primary">
          ...
          <Card className="mb-8">
            <CardContent className="pt-6">
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <h2 className="text-xl font-semibold mb-2">无法加载课堂记录</h2>
                <p className="text-muted-foreground mb-6">
                  抱歉，无法加载ID为 {params.id} 的课堂记录。请稍后再试。
                </p>
                <Button asChild>
                  <Link href="/dashboard/classroom-moments">返回列表</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
